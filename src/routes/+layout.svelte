...
<div class="bg-primary-fifty text-primary-ninefifty">
	<div class="container navbar flex flex-row justify-between p-6 sticky top-0 z-50 bg-primary-fifty">
