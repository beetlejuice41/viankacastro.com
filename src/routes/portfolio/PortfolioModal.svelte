...
<Modal
  ...
  triggerBase="h-fit w-full hover:brightness-50 object-cover transition-all ease-in-out"
  contentBase="card bg-pink-light p-4 space-y-4 shadow-xl overflow-hidden"
...
>
    ...
    {#snippet content()}
        ...
        <button class="relative float-right" onclick={modalClose} aria-label="Close Window"><svg class="" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M18 6 6 18"/><path d="m6 6 12 12"/></svg></button>
